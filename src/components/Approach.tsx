...
export function Approach() {
  return (
    <section className="py-16 px-6 lg:px-8 bg-gradient-to-b from-background via-secondary/10 to-background relative overflow-hidden">
      {/* Subtle background decoration */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-1/4 left-10 w-64 h-64 bg-primary/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 right-10 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
          ...
          <Card className="group relative overflow-hidden p-6 border-2 border-red-200/40 bg-gradient-to-br from-red-50/80 via-red-50/40 to-background hover:shadow-xl hover:shadow-red-100/20 transition-all duration-500 hover:scale-[1.01]">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="space-y-3">
                <div className="p-4 bg-background/80 backdrop-blur-sm rounded-lg border border-red-200/30 hover:border-red-300/50 transition-all duration-300 hover:translate-x-1">
                ...
                <div className="flex justify-center">
                  <div className="w-0.5 h-6 bg-gradient-to-b from-red-300/40 to-transparent"></div>
                </div>
          ...
          <Card className="group relative overflow-hidden p-6 border-2 border-emerald-200/40 bg-gradient-to-br from-emerald-50/80 via-emerald-50/40 to-background hover:shadow-xl hover:shadow-emerald-100/20 transition-all duration-500 hover:scale-[1.01]">
            {/* Animated gradient overlay */}
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div className="space-y-3">
                <div className="p-4 bg-background/80 backdrop-blur-sm rounded-lg border border-emerald-200/30 hover:border-emerald-300/50 transition-all duration-300 hover:translate-x-1">
                ...
                <div className="flex justify-center">
                  <div className="w-0.5 h-6 bg-gradient-to-b from-emerald-300/40 to-transparent"></div>
                </div>
                ...
                <div className="flex justify-center">
                  <div className="w-0.5 h-6 bg-gradient-to-b from-emerald-300/30 to-transparent"></div>
                </div>

                <div className="p-5 bg-gradient-to-br from-emerald-100/40 to-emerald-50/20 rounded-lg border-2 border-emerald-200/40 shadow-lg hover:shadow-emerald-200/30 transition-all duration-300">
                  <div className="font-bold text-base mb-1 bg-gradient-to-r from-emerald-600 to-emerald-700 bg-clip-text text-transparent">
